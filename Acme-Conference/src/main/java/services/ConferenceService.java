...
public class ConferenceService {
	...
	public List<String> findBuzzwords() {
		...
		//Las claves ser�n las palabras y los valores su frecuencia
		final Map<String, Integer> stringCountMap = new TreeMap<String, Integer>();

		//Para cada palabra, si no exist�a se introduce en el map
		//Si ya exist�a se aumenta su frecuencia en 1
		...
		//Se busca cu�l es la palabra con mayor frecuencia
		Integer ind = 0;
		String buzztop = "";
		...
		//A partir de esta palabra se obtienen todas las buzzwords (20% m�s frecuentes)
